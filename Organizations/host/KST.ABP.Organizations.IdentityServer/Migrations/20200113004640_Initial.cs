...
namespace KST.ABP.Organizations.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "OrganizationsOrganizationUnit",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    ExtraProperties = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationsOrganizationUnit", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrganizationsOrganizationUnit_OrganizationsOrganizationUnit_ParentId",
                        column: x => x.ParentId,
                        principalTable: "OrganizationsOrganizationUnit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "OrganizationsOrganizationUnitRole",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    CreationTime = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationsOrganizationUnitRole", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OrganizationsUserOrganizationUnit",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    CreationTime = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationsUserOrganizationUnit", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationsOrganizationUnit_Code",
                table: "OrganizationsOrganizationUnit",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationsOrganizationUnit_ParentId",
                table: "OrganizationsOrganizationUnit",
                column: "ParentId");
        }
